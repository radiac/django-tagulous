...
urlpatterns = (
    mk_urlpatterns(url(r'^tagulous_tests_app/',
                       include(mk_urlpatterns(
                           # CBV with tagged forms
                           url(r'views/$',
                               views.null,
                               name='tagulous_tests_app-null'),
                           ...
                           url(r'^autocomplete/unlimited/$',
                               ...
                               {'tag_model':
                                tagged_model.autocomplete_view.tag_model},
                               name='tagulous_tests_app-unlimited'),

                           url(r'^autocomplete/limited/$',
                               tagulous.views.autocomplete,
                               {'tag_model':
                                tagged_model.autocomplete_limit.tag_model},
                           ...
                           url(r'^autocomplete/unlimited/queryset/$',
                               tagulous.views.autocomplete,
                               {'tag_model':
                                tagged_model.autocomplete_view.tag_model.objects.filter(
